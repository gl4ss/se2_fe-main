...
const HomePage = () => {
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" onClick={handleSortByPriceLowest}>Price: Low to High</a></li>
    <li><a class="dropdown-item" onClick={handleSortByPriceHighest}>Price: High to Low</a></li>
  </ul>
</div>
              </div>
